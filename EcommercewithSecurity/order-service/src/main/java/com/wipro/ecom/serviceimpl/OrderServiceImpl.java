...
import com.wipro.ecom.cbservice.ProductCBService;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    private ProductCBService productCBService;

    
    private OrderDTO convertToDTO(Order order) {
    	System.out.println("Calling Product Service from DTO...");
        ...
        List<OrderItemDTO> items = order.getItems().stream().map(oi -> {
        	...
        	ProductDTO product = productCBService.getProduct(oi.getProductId());
	...
	public OrderDTO userFallback(Long cartId,Throwable ex) {
	...
	public Object getUserWithCB(Long userId) {
	...
	public OrderDTO placeOrder(Long cartId) {
	    ...
	    Object user = getUserWithCB(cart.getUserId());
	    ...
	    for (CartItem ci : cart.getItems()) {
	        ...
	        ProductDTO product = productCBService.getProduct(ci.getProductId());
